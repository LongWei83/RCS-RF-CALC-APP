...
/* Generated from ../O.Common/rcsRfCalc.dbd */
...
int rcsRfCalc_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/long/Epics/Apps/RCS-RF-CALC-APP";
...
/* rcsRfCalc_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"rcsRfCalc_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    rcsRfCalc_registerRecordDeviceDriver(*iocshPpdbbase);
}
